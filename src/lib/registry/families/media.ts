...
// Names and descriptions copied verbatim from src/routes/media/+page.svelte card grid.
// Order matches the hub page display order.
export const mediaTools: ToolEntry[] = [
	{
	...
	},
	{
		...
		keywords: ['compress', 'audio', 'reduce', 'size', 'mp3'],
		related: ['/media/trim-audio', '/audio/convert', '/audio/normalize', '/audio/merge'],
		sitemap: { changefreq: 'monthly', priority: 0.8 }
	},
	{
		...
		keywords: ['gif', 'animated', 'gif maker', 'convert', 'video', 'clip', 'animation'],
		related: ['/media/trim-video', '/media/compress-video', '/media/extract-audio', '/photo/compress'],
		sitemap: { changefreq: 'monthly', priority: 0.8 }
	},
	{
		...
		family: 'media',
		name: 'Extract Audio',
		description: 'Pull audio track from any video',
		icon: 'M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3',
		keywords: ['extract', 'audio', 'video', 'track', 'mp3'],
		related: ['/media/trim-audio', '/media/compress-audio', '/audio/convert', '/media/trim-video'],
		sitemap: { changefreq: 'monthly', priority: 0.8 }
	}
];
