...
export const audioTools: ToolEntry[] = [
	{
		...
		related: ['/audio/merge', '/audio/normalize', '/media/compress-audio', '/media/trim-audio'],
		popular: true,
	...
	},
	{
		...
		related: ['/audio/convert', '/audio/normalize', '/media/trim-audio', '/media/compress-audio'],
	...
	},
	{
		...
		related: ['/audio/convert', '/audio/merge', '/media/compress-audio', '/media/trim-audio'],
		sitemap: { changefreq: 'monthly', priority: 0.8 }
	}
];
