...
<header class="mx-auto w-full max-w-6xl px-4 pt-6 pb-2 sm:px-6 sm:pt-8 lg:px-8">
	<div class="flex items-center justify-between">
		<a href="/" class="flex items-center gap-1.5 font-display text-xl font-700 tracking-tight text-brand">
			<svg class="h-5 w-5" viewBox="0 0 480 464" fill="currentColor" aria-hidden="true">
		...
		<div class="flex items-center gap-1">
			...
			<nav class="hidden items-center gap-1 text-sm sm:flex">
				{#each topLinks as link}
					<a
						href={link.href}
						class="rounded-md px-2.5 py-1.5 transition-colors hover:text-accent {link.match(pathname) ? 'text-accent font-medium' : 'text-text-muted'}"
					>
						{link.label}
					</a>
				{/each}
				...
				<div class="relative">
					<button
						...
						class="flex items-center gap-1 rounded-md px-2.5 py-1.5 transition-colors hover:text-accent {toolsOpen ? 'text-accent font-medium' : 'text-text-muted'}"
				...
				<a
					href="/why"
					class="rounded-md px-2.5 py-1.5 transition-colors hover:text-accent {pathname.startsWith('/why') ? 'text-accent font-medium' : 'text-text-muted'}"
				>
					Why
				</a>
				...
				<a
					...
					class="rounded-md px-2 py-1.5 text-text-muted transition-colors hover:text-accent"
					aria-label="GitHub"
				>
