<script lang="ts">
	...
	const faqs = [
		{
			question: 'What does this tool actually remove from SVG files?',
			answer:
		...
		{
			question: 'How much smaller will my SVG get?',
			answer:
		...
		{
			question: 'Can I paste SVG markup directly instead of uploading a file?',
			answer:
...
<ToolShell
	...
	tagline="Strip editor metadata, remove comments, collapse whitespace, and round coordinates to shrink SVG file size."
	seoTitle="SVG Optimizer & Minifier — Shrink SVG Files Free | nah.tools"
	description="Optimize and minify SVG files: remove editor metadata, comments, and whitespace, and round coordinates. Free, no upload — runs entirely in your browser."
	{faqs}
>
	<section class="mx-auto max-w-4xl space-y-6">
		...
		<div class="space-y-4 rounded-xl border border-border bg-surface-alt p-6">
			<h2 class="font-display text-lg font-700">Why SVGs exported from design tools are bloated</h2>
