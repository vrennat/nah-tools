...
const routes: { path: string; changefreq: string; priority: string }[] = [
	...
	{ path: '/pdf/pdf-to-svg', changefreq: 'monthly', priority: '0.8' },
	...
	{ path: '/pdf/compare', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/crop', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/edit', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/extract-images', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/fill-sign', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/flatten', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/ocr', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/pdf-to-csv', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/pdfa', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/protect', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/redact', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/unlock', changefreq: 'monthly', priority: '0.7' },
	{ path: '/pdf/word-to-pdf', changefreq: 'monthly', priority: '0.7' },
	...
	{ path: '/photo/exif', changefreq: 'monthly', priority: '0.8' },
	{ path: '/photo/crop', changefreq: 'monthly', priority: '0.8' },
	{ path: '/photo/favicon', changefreq: 'monthly', priority: '0.8' },
	{ path: '/photo/svg-optimize', changefreq: 'monthly', priority: '0.7' },
	...
	{ path: '/invoice', changefreq: 'weekly', priority: '0.9' },
	{ path: '/bio', changefreq: 'weekly', priority: '0.9' },
